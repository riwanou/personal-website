...
<div class="flex justify-center">
	<div class="mx-5 my-16 flex flex-col justify-center">
		<p class="pb-6 text-4xl font-semibold">Hey, Welcome.<br /></p>
		<p class="pb-2 text-xl font-medium">My name is Riwan Coëffic.</p>
		<p class="text-justify text-lg">
			I am a french computer-science student building stuff on the Web. <br />
			Eating rice and implementing my ideas is my way of life. <br />
